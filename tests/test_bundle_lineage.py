...
class RealTreeTests(ContractCase):
    def test_candidate_verifies_under_v2(self):
        ...
        if complete:
            ...
            # P9 (common XLSX reuse) declares one new runtime extract on top
            # of P8's 90 declared changes.
            self.assertEqual(91, rc["verified"])
    ...
    def test_manifest_v2_link(self):
        ...
        # fruit_trees first bundle).
        self.assertEqual(91, link["change_count"])
