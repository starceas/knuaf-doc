...
class RealTreeTests(ContractCase):
    def test_candidate_verifies_under_v2(self):
        ...
        if complete:
            ...
            # P13 (rda-lookup verification status) declares one new test
            # file on top of P12's 106 declared changes.
            self.assertEqual(107, rc["verified"])
            self.assertEqual(80, rc["new_count"])
        else:
    ...
    def test_manifest_v2_link(self):
        ...
        self.assertEqual(107, link["change_count"])
        self.assertEqual(80, link["new_count"])
        self.assertEqual(80, link["approved_new_files"])
